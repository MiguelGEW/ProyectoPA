...
class CSVTest {
    ...
    void readTable() throws IOException {
        ...
        // assert that the correct number of rows are readTable
        assertEquals(25, table.getRowCount());

        // assert that the headers are correctly readTable
    ...
    void readTableWithLabels()  throws IOException {
        ...
        // assert that an arbitrary row is readTable correctly
